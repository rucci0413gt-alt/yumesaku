...
<a href="/hawkeye" className="feature-card">
<div className="feature-eyebrow">Hawkeye</div>
<h3 className="feature-name">狙う</h3>
<p className="feature-desc">鷹眼エージェントがトレンド商品を発掘</p>
<span className="feature-arrow">→</span>
</a>
...
.features-title { font-size: 24px; margin-bottom: 32px; }
...
.examples-label { font-size: 10px; }
.example-tag { font-size: 11px; padding: 5px 12px; }
}
...
.input-area { padding: 12px 14px 24px; }
.input-area.hero-input { padding: 0 14px 28px; }
